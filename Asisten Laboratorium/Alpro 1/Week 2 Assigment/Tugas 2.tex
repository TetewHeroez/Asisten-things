...
Persamaan lingkarannya adalah x^2 + y^2 - 4x - 6y -12 = 0
        ...
        Kita tahu bahwa variabel $p$ dan $q$ yang dapat bernilai "benar" atau "salah" mempunyai 4 kemungkinan pasangan berbeda (BB, BS, SB, dan SS). Buatlah program untuk membuat tabel kebenaran dari salah satu ekspresi logika berikut:
