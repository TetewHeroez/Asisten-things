              ...
              \item Kasus $2x - 5 > 0 \implies x > \frac{5}{2}$. Diperoleh
                    ...
                    \begin{center}
                        \begin{tikzpicture}
                            ...
                            \draw[fill=white] (2,-2) circle (0.06) node[below]{$\frac{25}{9}$};
                            \draw[fill=black] (1,-2) circle (0.06) node[below]{$\frac{5}{2}$};
                        \end{tikzpicture}
                    \end{center}
              \item Kasus $2x - 5 < 0 \implies x < \frac{5}{2}$.
                    ...
                    \begin{align*}
                        \frac{x}{|2x - 5|} > 5 & \iff \frac{x}{-(2x - 5)} > 5 \\
                                               ...
                                               & \iff x < \frac{25}{11}.
                    \end{align*}
                    Dengan demikian, himpunan penyelesaian pada kasus ini adalah $\left(-\infty,\frac{25}{11}\right)$.
          \end{itemize}
          Dengan menggabungkan kedua himpunan penyelesaian tersebut, maka himpunan penyelesaian dari pertidaksamaan tersebut adalah
          $
              S = \left(\frac{25}{11},\frac{25}{9}\right).
          $
\end{enumerate}
\end{document}