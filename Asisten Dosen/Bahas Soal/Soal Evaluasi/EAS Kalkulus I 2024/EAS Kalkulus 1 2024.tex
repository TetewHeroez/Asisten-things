...
\renewcommand{\headrulewidth}{1pt}
\begin{enumerate}
    \item Asumsi pada soal mengatakan bahwa bagian alas dan penutup memiliki biaya dua kali lebih mahal daripada sisi-sisinya. Mungkin ini bisa diartikan bahwa luasan sisi-sisi kotak nya sama, atau dengan kata lain alas dan penutupnya berbentuk persegi.
          \begin{center}
              \begin{tikzpicture}[scale=0.8]
                  \def\sisi{2}
                  \def\tinggi{4}
                  \coordinate (A) at (0,0,0);
                  \coordinate (B) at (\sisi,0,0);
                  \coordinate (C) at (\sisi,\sisi,0);
                  \coordinate (D) at (0,\sisi,0);
                  \coordinate (A') at (0,0,\tinggi);
                  \coordinate (B') at (\sisi,0,\tinggi);
                  \coordinate (C') at (\sisi,\sisi,\tinggi);
                  \coordinate (D') at (0,\sisi,\tinggi);
                  \foreach \p/\q in {C/C', D/D', C/D,B/C,B/B', A'/B', B'/C', C'/D', D'/A'}{
                          \draw[thick] (\p) -- (\q);
                      }
                  \foreach \p/\q in { A/A',A/B,D/A}{
                          \draw[thick,dashed] (\p) -- (\q);
                      }
                  \draw[<->] (-0.5,0,\tinggi) -- (-0.5,\sisi,\tinggi) node[midway,left] {$s$};
                  \draw[<->] (0,-0.5,\tinggi) -- (\sisi,-0.5,\tinggi) node[midway,below] {$s$};
                  \draw[<->] (\sisi+0.5,0,0) -- (\sisi+0.5,0,\tinggi) node[midway,right] {$t$};
              \end{tikzpicture}
          \end{center}
          Dengan $s$ adalah panjang sisi alas dan penutup, serta $t$ adalah tinggi kotak. Maka, volume kotak dapat dituliskan sebagai
          \[
              V = s^2 t = 2000 \implies t = \frac{2000}{s^2}.
          \]
          Selanjutnya misalkan untuk biaya per cm$^2$ adalah \st{Rp.1000} Rp.1\footnote{kena redenominasi njir}, maka biaya total \( C(s) \) dalam rupiah dapat dituliskan sebagai berikut:
          \begin{align*}
              C(s) & = 2 \cdot (\text{Luas Alas}) + 2 \cdot (\text{Luas Penutup}) + 1 \cdot (\text{Luas Sisi-sisi}) \\
              C(s) & = 2 \cdot (s^2) + 2 \cdot (s^2) + 1 \cdot (4st)                                                \\
              C(s) & = 4s^2 + 4s \left( \frac{2000}{s^2} \right)                                                    \\
              C(s) & = 4s^2 + \frac{8000}{s}.
          \end{align*}
          Untuk mencari nilai \( s \) yang meminimalkan biaya, maka turunkan \( C(s) \) dan cari titik kritisnya:
          \[
              C'(s) = 8s - \frac{8000}{s^2}.
          \]
          Titik kritis diperoleh dengan menyelesaikan persamaan \( C'(s) = 0 \):
          \begin{align*}
              0 & = 8s - \frac{8000}{s^2}
              \implies 8s^3 = 8000
              \implies s^3 = 1000
              \implies s = 10.
          \end{align*}
          Untuk memastikan bahwa titik kritis tersebut merupakan titik minimum, maka tinjau tanda dari \( C''(s) \) di $s = 10$:
          \[
              C''(s) = 8 + \frac{16000}{s^3} \implies C''(10) = 8 + \frac{16000}{1000} = 24 > 0.
          \]
          Karena \( C''(10) > 0 \), maka \( s = 10 \) adalah titik minimum. Selanjutnya, hitung nilai \( t \) pada titik tersebut:
          \[
              t = \frac{2000}{(10)^2} = \frac{2000}{100} = 20.
          \]
          Jadi, ukuran kotak yang meminimalkan biaya adalah \( 10\ \text{cm} \times 10\ \text{cm} \times 20\ \text{cm} \).
    \item \begin{enumerate}
              \item Untuk menentukan selang naik/turun, maka diperlukan informasi mengenai tanda dari \( f'(x) \).
                    Diperoleh
                    \[
