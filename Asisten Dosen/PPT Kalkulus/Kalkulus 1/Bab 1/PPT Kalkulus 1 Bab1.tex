...
\begin{document}
    {\usebackgroundtemplate{
        \tikz[overlay,remember picture] \node[opacity=0.1, at=(current page.center)]{\includegraphics[width=\paperwidth]{yuuka s}};}
    \begin{frame}
        \titlepage
    \end{frame}
    }
\AtBeginSection[]
{
    ...
    {\usebackgroundtemplate{
        \tikz[overlay,remember picture] \node[opacity=0.2, at=(current page.center)]{\includegraphics[width=\paperwidth]{motivated.jpg}};
        }
    \begin{frame}
